...
/* Updated SystemC code with modified wait statements */
...
SC_MODULE(BlurX)
{
    ...
    void BlurX_Slice0()
    {
        while(1){
            ...
            wait(22, SC_MS);  // Updated wait time
    ...
    *******************************************************************************/
    ...
    void main(void)
    {
        while(1)
        {
            ...
            wait(29, SC_MS);  // Updated wait time
    ...
    *******************************************************************************/
    ...
    void main(void)
    {
        while(1)
        {
            ...
            wait(13, SC_MS);  // Wait time remains the same
    ...
    *******************************************************************************/
    ...
    void main(void)
    {
        ...
        while(1)
        {
            ...
            wait(62, SC_MS);  // Updated wait time
    ...
    *******************************************************************************/
        ...
        for(r=0,pos=0;r<rows;r++){
            for(c=0;c<cols;c++,pos++){
                if(edge[pos] == POSSIBLE_EDGE){
                    hist[mag[pos]]++;
                    if(mag[pos] > maximum_mag) maximum_mag = mag[pos];
                }
            }
        }
    ...
    void main(void)
    {
        while(1)
        {
            MagIn.read(mag);
            NmsIn.read(nms);
            wait(36, SC_MS);  // Updated wait time
